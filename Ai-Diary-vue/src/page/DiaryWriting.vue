...
export default {
  ...
  setup() {
    ...
    // ✅ 로그인한 유저 ID 확인
    const userId = ref(localStorage.getItem("email") || localStorage.getItem("kakaoAccessToken") || "");
